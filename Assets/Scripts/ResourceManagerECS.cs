...
public class ResourceManagerECS : MonoBehaviour {
	...
	private Entity ResourceEntityPrefab;
	private EntityManager manager;

	public static ResourceManagerECS instance;
	...
	void Awake() {
		...
		ResourceEntityPrefab = GameObjectConversionUtility.ConvertGameObjectHierarchy(ResourcePrefab, settings);
	}
	void Start () {
